...
class LegacyHprofTest {
  ...
  @Test fun preM() {
    ...
    assertThat(analysis.allLeaks.sumOf { it.totalRetainedHeapByteSize ?: 0 }).isEqualTo(193431)
  }
  ...
  @Test fun androidM() {
    ...
    assertThat(analysis.allLeaks.sumOf { it.totalRetainedHeapByteSize ?: 0 }).isEqualTo(49584)
  }
  ...
  @Test fun gcRootReferencesUnknownObject() {
    ...
    assertThat(analysis.applicationLeaks).hasSize(2)
    assertThat(analysis.allLeaks.sumOf { it.totalRetainedHeapByteSize ?: 0 }).isEqualTo(5306218)
  }
  ...
  @Test fun androidO() {
    ...
    val leak = analysis.applicationLeaks[0].leakTraces.first()
    assertThat(leak.leakingObject.className).isEqualTo("com.example.leakcanary.MainActivity")
    assertThat(analysis.allLeaks.sumOf { it.totalRetainedHeapByteSize ?: 0 }).isEqualTo(211038)
  }
