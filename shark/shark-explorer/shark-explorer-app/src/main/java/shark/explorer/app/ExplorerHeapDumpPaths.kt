 ...
 */
internal fun explorerHeapDumpPaths(): HeapDumpPaths = HeapDumpPaths(HEAP_DUMP_PATHS_DIRECTORY)

private val HEAP_DUMP_PATHS_DIRECTORY = File(SHARK_EXPLORER_DIRECTORY, "heap-dump-paths")
