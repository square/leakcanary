...
/**
 * `android.graphics.Bitmap` as a heap dump has it, with the fields the explorer reads and no others.
 *
...
/** A real PNG, so that what a decoder reads and what the explorer reads out of its header agree. */
fun pngBytes(
  width: Int,
  height: Int
): ByteArray {
