 ...
 * `shark-dive-agent/harness/eval/run-eval.sh`, because it is process handling and nothing else, and
...
private val USAGE = """
  Shark Dive's agent eval, the half of it that isn't process handling.
  ...
  Run it through shark-dive-agent/harness/eval/run-eval.sh rather than by hand.
""".trimIndent()
