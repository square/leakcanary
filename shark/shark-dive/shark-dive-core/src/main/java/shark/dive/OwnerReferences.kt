...
import shark.dive.OwnedObjects.HeldByScopedProviders
import shark.dive.OwnedObjects.InstancesOf
...
internal class OwnerRule(
   ...
   *
   * Those are the references Shark Dive adds itself, to present a structure the way you think about it
...
internal class OwnerReferences private constructor(
   ...
   * dive reads for it own what they point at. For nearly every object of a heap dump, nothing at all.
   */
  ...
  companion object {
    ...
    /**
     * The scoped providers of the dependency injection frameworks Shark Dive knows about, read off a
    ...
    /**
     * The constructs Shark Dive knows about. Curated: each one is a claim that a reference is *the* way
