...
/**
 * What `android.os.Build` looks like in a dump, which is how Shark Dive knows which device to go to.
 *
 ...
 * Shark Dive can't name a known library leak in. See `ReferenceStrengthReader`.
 */
 ...
 * Duplicated from `shark-dive-core`'s tests rather than shared, since a test helper is not worth a
 * module's public API.
 */
