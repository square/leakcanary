...
class DiveAppTest {
  ...
  @Test fun `the chosen heap dump is opened`() {
    diveUiTest {
      ...
      setDiveContent(chooseHeapDumpFile = { heapDumpFile })
   ...
   * the window says has to be what the log says too. Where the log goes: [shark.dive.SessionLog].
   */
   ...
   * that has none does. Which window a chosen one lands in is `DiveWindowTest`'s.
   */
  private fun ComposeUiTest.setDiveContent(
