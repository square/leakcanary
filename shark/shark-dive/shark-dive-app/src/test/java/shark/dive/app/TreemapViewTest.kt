 ...
 * at. The layout and the hit testing themselves are unit tested in `shark-dive-core`.
 *
...
class TreemapViewTest {
  ...
  /** What [shark.dive.TreemapPresentation.of] does, for a tree that isn't a heap dump. */
