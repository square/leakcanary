 ...
 * hit testing are unit tested in `shark-dive-core`.
 */
...
class RadialViewTest {
  ...
  /** What [shark.dive.RadialPresentation.of] does, for a tree that isn't a heap dump. */
