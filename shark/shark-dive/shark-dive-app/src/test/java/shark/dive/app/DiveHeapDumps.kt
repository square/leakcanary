...
/**
 * The heap dumps [DiveAppTest] drives a window with, each shaped so that what it is about is what the
 ...
 * field names Coil's memory cache is made of, because that is what Shark Dive matches on. With
