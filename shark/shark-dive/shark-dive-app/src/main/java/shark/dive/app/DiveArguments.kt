 ...
 */
internal data class DiveArguments(
   ...
   *
   * Several Shark Dive windows open at once look alike in the window list — same app, often the same heap dump,
  ...
  companion object {
     ...
     * missing heap dump.
     */
    fun parse(args: List<String>): DiveArguments {
