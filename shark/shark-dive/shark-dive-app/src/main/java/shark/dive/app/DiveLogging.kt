 ...
 * much heap it was given, since a heap dump too large for Shark Dive runs out of exactly that.
 */
private fun logEnvironment(sessionLog: SessionLog?) {
  ...
  SharkLog.d {
    ...
    "Shark Dive ${SharkDiveVersion.current} starting" +
