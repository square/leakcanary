...
Shark Dive is a desktop app that reads a heap dump, and every screen and button of it is also a tool you
...
```bash
"/Applications/Shark Dive.app/Contents/MacOS/Shark Dive" --agent <tool> name=value …
```
