...
class RandomAccessFileSourceProvider(private val file: File) : DualSourceProvider {
  ...
  override fun openRandomAccessSource(): RandomAccessSource {
    ...
    return object : RandomAccessSource {
      override fun read(
        ...
        var toRead: Int = min(byteCountInt, maxRead)
        while (totalBytesRead < byteCount) {
          ...
          toRead = min(byteCountInt - totalBytesRead, maxRead)
        }
