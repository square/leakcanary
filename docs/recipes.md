...
In Java, you can use [ConfigBuilder](/leakcanary/api/leakcanary-object-watcher-android/leakcanary/appwatcherconfig/-config-builder/) instead:
```
...
In Java, you can use [ConfigBuilder](/leakcanary/api/leakcanary-android-core/leakcanary/config/-config-builder/) instead:
```
