...
<img src="../images/history-icon-first.png" width="160" alt="The first LeakCanary icon: a hand outlined canary on a generated shield">

The outline was rough, so Romain Guy redrew the whole thing in a vector file:

<img src="../images/history-icon-vector.svg" width="160" alt="Romain Guy's vector redraw of the LeakCanary icon">
